      ...
      <View style={{ height: Dimensions.get('window').height - 75 - (adjust ? 0 : 35) }} >
        ...
        >
          <View style={{ marginTop: 10, borderColor: '#bbb', borderWidth: 1, backgroundColor: 'linen', paddingTop: 10, paddingBottom: 10, paddingLeft: 20, paddingRight: 20 }}>
            <Text style={{ paddingBottom: 3 }}>{'Your account has been created, an email will be sent to you to complete validation. Following email verification, you have to activate the EZPartD app to get access to all features.'}</Text>
            <Text style={{ paddingBottom: 3 }}>{'You can provide a mobile phone number to receive your validation code or you can choose to use the email address you provided.'}</Text>
          </View>
